...
| The radar chain recovers a flood from backscatter | ✅ **Measured on real Copernicus terrain, all 22 districts.** Lowland and coastal (n=16): precision **0.84**, recall **0.75**, F1 **0.79**. Steep mountain (n=6): precision **0.83**, recall **0.18**, F1 **0.25** |
